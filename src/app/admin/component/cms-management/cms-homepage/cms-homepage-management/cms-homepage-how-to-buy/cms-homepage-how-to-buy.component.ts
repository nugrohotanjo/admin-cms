...
// service 
import { CmsHomepageOurProductService }         from './cms-homepage-how-to-buy.service'
...
@Component({
  selector: 'app-cms-homepage-how-to-buy',
  templateUrl: './cms-homepage-how-to-buy.component.html',
  styleUrls: ['./cms-homepage-how-to-buy.component.css']
})
export class CmsHomepageHowToBuyComponent implements OnInit {
  ...
  ListCarousel                          : Array<CmsHomepageHowToBuy> = [];
  ...
  public createCms() {
    ...
    .subscribe((datas) => {
      ...
      if (index === -1) {
        ...
        // save data carousel
        let data = new CmsCarouselPosition(this.idCmsCarouselPosition,'homepage-how-to-buy',JSON.stringify(this.ListCarousel));
        this.cmsCarouselPositionService.saveCarousel(data)
                  .subscribe((data) => {
                    ...
                    // notification
                    this.sweetalertService.yourWorkHasBeenSaved('Carousel How To Buy Has Been Save')
  ...
  public loadData() {
    ...
    // get list position
    this.cmsCarouselPositionService.getCarouselByCategory('homepage-how-to-buy')
        .subscribe((data) => {
  ...
  public deleteCarousel(id) {
    ...
    this.cmsHomepageOurProductService.destroyCarousel(id)
            .subscribe((data) => {
              // notification
              this.sweetalertService.yourWorkHasBeenSaved('Carousel How to Buy Has Been Deleted')
